import enum
from sqlalchemy import Column, DateTime, Integer, String, Time, Date, Enum, ForeignKey, Text, Float, func
...
class OTType(str, enum.Enum):
    NORMAL_DAY = "normal_day"           # Ngày thường (x1.5)
    WEEKEND_DAY = "weekend_day"         # Nghỉ hàng tuần - Ngày (x2.0)
    HOLIDAY_DAY = "holiday_day"         # Lễ, Tết - Ngày (x3.0)
